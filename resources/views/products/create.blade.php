...
@section('title', 'Add product — SDJ Gadget Hub')
    ...
    >
        <div class="row g-3">
            ...
            <div class="col-md-4">
                ...
                <input type="number" min="0" class="form-control" id="stock_quantity" name="stock_quantity" value="{{ old('stock_quantity') }}" required>
